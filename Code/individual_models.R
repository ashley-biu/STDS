...
# autogenerated plot
performance::check_model(cpi.nb.mod, theme = "gplot2::classic",colors = c("#FAA92C", "#3F84E5", "#731DD8"),
)
...
performance::check_model(employment.nb.mod, theme = "gplot2::classic",colors = c("#FAA92C", "#3F84E5", "#731DD8"),
)
########### UNEMPLOYMENT
...
# autogenerated plot
performance::check_model(unemployment.nb.mod, theme = "gplot2::classic",colors = c("#FAA92C", "#3F84E5", "#731DD8"),
)
...
#  Poisson Regression 
population.pos.mod <-  glm(fatality_number ~ tot_pop_num_in_millions, data=research_data, family="poisson")
...
population.nb.mod <- glm.nb(fatality_number ~ tot_pop_num_in_millions,
                            data = research_data)
...
# autogenerated plot diagnostics
performance::check_model(population.nb.mod, theme = "gplot2::classic",colors = c("#FAA92C", "#3F84E5", "#731DD8"),
)
...
#  Poisson Regression 
youth.pos.mod <-  glm(fatality_number ~ youth_proportion_in_millions, data=research_data, family="poisson")
...
# negative bimomial model
youth.nb.mod <- glm.nb(fatality_number ~ youth_proportion_in_millions,
                       data = research_data)
...
# plot diagnostics
# autogenerated plot
performance::check_model(youth.nb.mod, theme = "gplot2::classic",colors = c("#FAA92C", "#3F84E5", "#731DD8"),
)
...
# autogenerated plot of diagnostics
performance::check_model(gdp.nb.mod, theme = "gplot2::classic",colors = c("#FAA92C", "#3F84E5", "#731DD8"),
)
...
# autogenerated plot
performance::check_model(light.vehicles.nb.mod, theme = "gplot2::classic",colors = c("#FAA92C", "#3F84E5", "#731DD8"),
)
...
# autogenerated plot
performance::check_model(heavy.vehicles.nb.mod, theme = "gplot2::classic",colors = c("#FAA92C", "#3F84E5", "#731DD8"),
)
...
# autogenerated plot
performance::check_model(motorcycles.nb.mod, theme = "gplot2::classic",colors = c("#FAA92C", "#3F84E5", "#731DD8"),
)
...
# autogenerated plot
performance::check_model(vehicles.mil.nb.mod, theme = "gplot2::classic",colors = c("#FAA92C", "#3F84E5", "#731DD8"),
)
...
#autogenerated plots
performance::check_model(twi.nb.mod, theme = "gplot2::classic",colors = c("#FAA92C", "#3F84E5", "#731DD8"),
)
...
# autogenerated plot
performance::check_model(petrol.nb.mod, theme = "gplot2::classic",colors = c("#FAA92C", "#3F84E5", "#731DD8"),
)
...
# autogenerated plot
performance::check_model(diesel.nb.mod, theme = "gplot2::classic",colors = c("#FAA92C", "#3F84E5", "#731DD8"),
)
